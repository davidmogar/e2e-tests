...
require (
	...
	github.com/davidmogar/release-service v0.0.0-20231009121212-3b57f77670fb
...
replace github.com/redhat-appstudio/release-service => github.com/davidmogar/release-service v0.0.0-20230926115200-6b1480ca0688
